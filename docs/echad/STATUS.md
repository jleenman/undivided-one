...
- Program phase: bootstrap / initial correction
- Current branch: `codex/echad-research-program` (based on current `origin/main` Nuxt source)
- Last completed prompt: ECHAD-002 dry-run; status `review`
- Next queue task: **ECHAD-001 — Baseline en claiminventaris** (`P0`, `ready`, no dependencies)
- Core essay gate: closed; ECHAD-002–009 must be `review` or `done` and proposals need human approval.
- Public baseline: NL essay 12,644 rendered words; EN essay 12,682; both measured 2026-07-12.
- Automations: all three requested schedules are `ACTIVE` in isolated worktree mode; see `AUTOMATIONS.md`.
